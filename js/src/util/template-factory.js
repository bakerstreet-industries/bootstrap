...
class TemplateFactory {
  ...
  getContent() {
    return Object.values(this._config.content).filter(Boolean)
  }
  ...
  _putElementInTemplate(element, templateElement) {
    ...
    if (element.outerHTML === templateElement.outerHTML) { // is the same
      return
    }

    if (element.parentNode === templateElement) { // guess we are avoiding infinite loop
      return
    }
